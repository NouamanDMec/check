...
const MenuDemo = ({ children }: any) => {
    ...
    const breadcrumbItems = [{ label: 'Computer' }, { label: 'Notebook' }, { label: 'E-Commerce' }, { label: 'Backpacks' }, { label: 'Item' }];

    const wizardItems = [
        { label: 'Profil', command: () => router.push('/uikit/menu') },
        { label: 'Projet', command: () => router.push('/uikit/menu/seat') },
        { label: 'Docuements a l appui', command: () => router.push('/uikit/menu/payment') },
        {
            label: 'Confirmation',
    ...
    return (
                ...
                <div className="card">
                    <h5>Formulaire de soumission</h5>
                    ...
                    {pathname === '/uikit/menu' ? (
                        <div className="flex align-items-center py-5 px-3">
                            ...
                            <p className="m-0 text-lg">Formulaire 1</p>
                        </div>
                    ) : (
                        <>{children}</>
                    )}
